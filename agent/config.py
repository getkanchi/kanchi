...
class Config:
    ...
    frontend_dist_path: str = field(
        default_factory=lambda: os.getenv("FRONTEND_DIST_DIR") or str(BASE_DIR / "ui")
    )
    frontend_index_file: str = os.getenv("FRONTEND_INDEX_FILE", "index.html")
    frontend_cache_index: bool = _as_bool(os.getenv("FRONTEND_CACHE_INDEX", "true"), default=True)
    ...
    token_secret_key: str = os.getenv(
        "TOKEN_SECRET_KEY",
        os.getenv("SESSION_SECRET_KEY", "change-me"),
    )
