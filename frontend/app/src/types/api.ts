...
> extends HttpClient<SecurityDataType> {
  api = {
    ...
    /**
     * @description Preview or execute a guarded bulk action across selected tasks.
     *
     * @tags tasks
     * @name BulkTaskActionApiTasksBulkActionPost
     * @summary Bulk Task Action
     * @request POST:/api/tasks/bulk-action
     */
    bulkTaskActionApiTasksBulkActionPost: (
      data: BulkTaskActionRequest,
      params: RequestParams = {},
    ) =>
      this.request<BulkTaskActionResult, HTTPValidationError>({
